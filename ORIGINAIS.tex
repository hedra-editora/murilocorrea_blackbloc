...
{[}...{]} apenas discordamos disso com afeto.

\chapter{Apresentação}

\begin{flushright}
\emph{por Bruno Cava}\footnote{Mestre em Filosofia e Teoria do Direito (\versal{UERJ}), é autor de ``A multidão foi ao deserto'' (Annablume, 2013), e bloga em \textless{} http://quadradodosloucos.com.br \textgreater{}.}
\end{flushright}
...
inequivocamente ``criminosa''}\emph{\footnote{\versal{O GLOBO}. Polícia vai
...
sanitária.\textsuperscript{\footnote{\versal{FOLHA DE SÃO PAULO}. Catador é o
...
\section{Olho por olho\textsuperscript{\emph{\footnote{Poema de Augusto de
